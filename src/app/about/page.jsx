...
export const metadata = {
  title: "About Us",
  description:
    "Learn about DeRivian Care Ltd — our mission, our values of Care, Comfort and Compassion, the DeRivian way, and the leadership team behind our London domiciliary care.",
}
      ...
      <section className="section scheme-1">
        <div className="container">
          <div className="hero__head reveal" style={{ marginBottom: "var(--section-y)" }}>
            ...
            <h1>Our journey to exceptional care</h1>
            <p className="lead">
              DeRivian Care Ltd is a London-based provider specialising in high-quality domiciliary care for adults in their own homes. We exist to deliver personal care that keeps people safe, well and independent — where dignity and choice remain central to every moment of every day.
            </p>
            <p className="lead" style={{ marginTop: "1.25rem" }}>
              Built on the values of Care, Comfort and Compassion, we combine extensive experience in care coordination, safeguarding and regulatory compliance with a genuinely human approach. The result is care that is safe, responsive and outcome-focused — and built entirely around the person receiving it.
            </p>
          ...
          <div className="facts reveal">
            <div className="fact"><strong>18&ndash;65+</strong><span>Adults supported across every stage of adult life</span></div>
            <div className="fact"><strong>CQC</strong><span>Aligned to the five fundamental standards of care</span></div>
            <div className="fact"><strong>London</strong><span>Serving Plumstead and surrounding boroughs</span></div>
          </div>
        </div>
      </section>
      ...
      <section className="section scheme-2">
        <div className="container">
          <div className="heading heading--center reveal">
            ...
            <p className="lead">
              We built DeRivian on three pillars. These aren&apos;t words on a wall — they&apos;re the reason we show up, the way we listen, and how we treat every person we support.
            </p>
          </div>
          <div className="grid grid--3">
            <article className="feature reveal">
              ...
              <h4>Care</h4>
              <p>We learn from every interaction and never stop improving. Care that adapts to meet each person exactly where they are, today and as their needs change.</p>
            </article>
            <article className="feature reveal">
              <div className="feature__icon">
              ...
              <h4>Comfort</h4>
              <p>Independence is the real goal. Our support exists to help people do what matters most to them — safely, confidently and in the comfort of their own home.</p>
            </article>
            <article className="feature reveal">
              <div className="feature__icon">
              ...
              <h4>Compassion</h4>
              <p>We honour the choices, culture and preferences of those we care for — with respect in every moment, even when the harder path is the right one.</p>
            </article>
          </div>
        </div>
      </section>
          ...
          <div>
            <div className="deriway__intro-wrap">
              <div className="deriway__intro reveal">
                ...
                <p className="lead">
                  We invest deeply in our staff because they are the heart of everything we do. Strong, supported teams deliver the consistent, compassionate care that families trust and people deserve.
                </p>
      ...
      <section className="section scheme-2" id="team">
        <div className="container">
          <div className="heading heading--center reveal">
            ...
            <h2>Meet our team</h2>
            <p className="lead">
              Three leaders guide DeRivian with unwavering commitment to care, comfort and compassion. Their experience in domiciliary care, safeguarding and care planning ensures every decision serves our clients — and stands up to the highest CQC standards.
            </p>
          </div>
          <div className="team">
          ...
          <div className="band reveal" style={{ marginTop: "var(--section-y)" }}>
            <div className="band__text">
              ...
              <p className="lead">We&apos;re always interested in compassionate people who share our values. Competitive pay, real development and a team that supports you.</p>
            </div>
